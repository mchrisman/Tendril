...
test('replace value binding - all array elements', () => {
  ...
  const result = replaceVars('{a[(_ as $x)]:$y}', {a: [1, 2, 3]}, (sol) => {
    return {y: sol.x + 99};
  });
